...
import os
import csv
from SimulacioDecidimOptimAudit import SimulacioDecidimOptimAudit

class SimulacioAudit:
    
    ##############################################################################
    #
    # IA - NO Seleccionadas - ALEATORIA
    #
    ##############################################################################
    def sim1(self):  
        print("****************************************************************")
        print("* IA - NO Seleccionadas - Aleatoria")
        print("****************************************************************")
        wd = os.getcwd()
        nameFile = "IA_NOS_ALE"
        ...
        datafileAudit = wd +"/Simulacio/"+ nameFile + "_AUDIT.txt"
        fileAudit = open(datafileAudit, "w")
        ...
        for i1 in range(0,10):          
            for i2 in range(i1+1,10):
                for i3 in range(i2+1,10):
                    ...
                    if sumEXC+importP[seleccio[3]] > 23:
                        # amb 4 es suficient
                        ctrl[seleccion2[0]] = 1
                        ctrl[seleccion2[1]] = 1
                        ctrl[seleccion2[2]] = 1
                    ...
                    problem.inputData("ExperimentData/Simulacio/Simulacio.txt",seleccioP,ctrlS,indexCall)
                    problem.writeLP()
                    returnOK = problem.solve()

                    auditLinea=str(seleccioP)+str(ctrlS)+ returnOK +"\n"
                    fileAudit.write(auditLinea)
    ...
    ##############################################################################
    #
    # R&S - NO Seleccionadas - ALEATORIA
    #
    ##############################################################################
    def sim2(self):  
        print("****************************************************************")
        print("* RS - NO Seleccionadas - Aleatoria")
        print("****************************************************************")
        wd = os.getcwd()
        nameFile = "RS_NOS_ALE"
        datafile = wd +"/Simulacio/"+ "/" + nameFile + ".txt"
    ...
    ##############################################################################
    #
    # IA - SI Seleccionadas - ALEATORIA
    #
    ##############################################################################
    def sim3(self):  
        print("****************************************************************")
        print("* IA - SI Seleccionadas - Aleatoria")
        print("****************************************************************")
        wd = os.getcwd()
        nameFile = "IA_SEL_ALE"
        datafile = wd +"/Simulacio/"+ "/" + nameFile + ".txt"
        ...
        for i1 in range(0,10):          
            for i2 in range(i1+1,10):
                for i3 in range(i2+1,10):
                    ...
                    seleccioCSV=[i1+1,i2+1,i3+1,seleccioP[0],seleccioP[1],seleccioP[2],seleccioP[3],seleccioP[4],seleccioP[5],seleccioP[6],seleccioP[7],seleccioP[8],seleccioP[9],str(int(sOK*1000000)),selcontrol]
                    csvwriter.writerow(seleccioCSV)
    ...
    ##############################################################################
    #
    # R&S - SI Seleccionadas - ALEATORIA
    #
    ##############################################################################
    def sim4(self):  
        print("****************************************************************")
        print("* RS - SI Seleccionadas - Aleatoria")
        print("****************************************************************")
        wd = os.getcwd()
        nameFile = "RS_SOL_ALE"
        datafile = wd +"/Simulacio/"+ "/" + nameFile + ".txt"
        ...
        for i1 in range(0,10):          
            for i2 in range(i1+1,10):
                for i3 in range(i2+1,10):
                    ...
                    for kk in range(10):
                        seleccioP[kk] = seleccio[kk]+1
                    linea  = str(aux0+1)+" "+str(aux1+1)+" "+str(aux2+1)+" "+str(seleccioP)+" "+str(sOK)+ " " + str(sEX) + " " +avisSEX+ " " + avisSOK+" lliures: "+str(lliures)
                    output.write(linea+"\n")
                    print(linea)
...
def main():
    problem = SimulacioAudit()
     
    opcio = input("Teclegi Opcio:\n")
    if opcio=="1":
        problem.sim1() # IA - NoSel  
    elif opcio=="2":
        problem.sim2() # RS - NoSel   
    elif opcio=="3":
        problem.sim3() # IA - SiSel  3
    elif opcio=="4":
        problem.sim4() # RS - SiSel  
    elif opcio =="99": 
